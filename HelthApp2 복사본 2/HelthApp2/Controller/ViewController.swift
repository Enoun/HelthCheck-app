...
class ViewController: UIViewController,FSCalendarDataSource, FSCalendarDelegateAppearance {
    ...
    @IBOutlet weak var recentHelth: UIView!
    @IBOutlet weak var myCondition: UIView!
    ...
    override func viewDidLoad() {
        ...
        calendarViewSet()
        viewSetup()
        recentHelth.layer.cornerRadius = 15
        myCondition.layer.cornerRadius = 15
    }
...
//        calendarView.appearance.headerTitleFont = UIFont(name: "NotoSansKR-Rarge", size: 18)
        // Weekday 폰트 설정
...
//        calendarView.appearance.titleDefaultColor = UIColor.white
        ...
        calendarView.layer.borderColor = UIColor.mainColor?.cgColor
